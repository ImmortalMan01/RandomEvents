...
package com.immortalman01.randomevents.language;
...
public class LanguageMessages {
	...
	private String tagPlugin;
        ...
        private String paintballTopKillTieSummary;
	...
	private String matchLeave;
       ...
       private String tooManySpawns;
       private String spawnsReset;
	...
	private String statsGuiAllTime;
	...
	private String guiCMD;
       ...
       private String killcoinsFuryModeName;
       private List<String> killcoinsFuryModeLore;
	...
	public void setMinigameDescriptionSPLEGG(List<String> minigameDescriptionSPLEGG) {
        ...
        public String getPaintballTopKillTieSummary() {
                String s = paintballTopKillTieSummary;
                try {
                        Matcher match = pattern.matcher(s);
                        Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                        while (match.find()) {
        ...
        public void setPaintballTopKillTieSummary(String paintballTopKillTieSummary) {
                this.paintballTopKillTieSummary = paintballTopKillTieSummary;
        }
	...
	public String getLacksInfoCreation() {
        ...
        public String getTooManySpawns() {
                String s = tooManySpawns;
                try {
                        Matcher match = pattern.matcher(s);
                        Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                        while (match.find()) {
        ...
        public void setTooManySpawns(String tooManySpawns) {
                this.tooManySpawns = tooManySpawns;
        }

       public String getSpawnsReset() {
               String s = spawnsReset;
               try {
                       Matcher match = pattern.matcher(s);
                       Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                       while (match.find()) {
       ...
       public void setSpawnsReset(String spawnsReset) {
               this.spawnsReset = spawnsReset;
       }
	...
	public String getStatsGuiAllTime() {
		String s = statsGuiAllTime;
		try {
			Matcher match = pattern.matcher(s);
			Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
			while (match.find()) {
	...
	public void setStatsGuiAllTime(String statsGuiAllTime) {
		this.statsGuiAllTime = statsGuiAllTime;
	}
	...
	public String getTeamItemName() {
       ...
       public String getKillcoinsStrongArmName() {
               String s = killcoinsStrongArmName;
               try {
                       Matcher match = pattern.matcher(s);
                       Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                       while (match.find()) {
       ...
       public void setKillcoinsStrongArmName(String killcoinsStrongArmName) {
               this.killcoinsStrongArmName = killcoinsStrongArmName;
       }

       public List<String> getKillcoinsStrongArmLore() {
               List<String> lista = new ArrayList<String>();
               if (killcoinsStrongArmLore != null) {
                       for (String s : killcoinsStrongArmLore) {
                               lista.add(ChatColor.translateAlternateColorCodes('&', s));
                       }
               }
               return lista;
       ...
       public String getKillcoinsFuryModeName() {
               String s = killcoinsFuryModeName;
               try {
                       Matcher match = pattern.matcher(s);
                       Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                       while (match.find()) {
       ...
       public void setKillcoinsFuryModeName(String killcoinsFuryModeName) {
               this.killcoinsFuryModeName = killcoinsFuryModeName;
       }

       public List<String> getKillcoinsFuryModeLore() {
               List<String> lista = new ArrayList<String>();
               if (killcoinsFuryModeLore != null) {
                       for (String s : killcoinsFuryModeLore) {
                               lista.add(ChatColor.translateAlternateColorCodes('&', s));
                       }
               }
               return lista;
       ...
       public void setKillcoinsFuryModeLore(List<String> killcoinsFuryModeLore) {
               this.killcoinsFuryModeLore = killcoinsFuryModeLore;
       }
       ...
       public String getActionbarStrongArm() {
               String s = actionbarStrongArm;
               try {
                       Matcher match = pattern.matcher(s);
                       Map<String, ChatColor> mapa = new HashMap<String, ChatColor>();
                       while (match.find()) {
       ...
       public void setActionbarStrongArm(String actionbarStrongArm) {
               this.actionbarStrongArm = actionbarStrongArm;
       }
