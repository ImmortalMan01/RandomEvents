...
public class Constantes {
	...
	public enum Messages {
		...
		PVP_KILL("pvpKill", "pvp.kill", "&a%killer% &4⚔ &c%victim%"),
                ...
                PAINTBALL_TOP_KILL_TIE_SUMMARY("paintballTopKillTieSummary", "match.paintballTopKillTieSummary", "&f&l---------------------------------------------\n&eIt's a tie!\n&9Blue kills: &f%blue_kills% &7- &cRed kills: &f%red_kills%\n\n&f&lTop Kills\n&7- &a%top1_name% &7(%top1_kills% kills)\n&7- &b%top2_name% &7(%top2_kills% kills)\n&7- &3%top3_name% &7(%top3_kills% kills)\n\n&fYour Kills: &e%player_kills%\n&f&l---------------------------------------------"),
		...
		KIT_ITEM_NAME("kitItemName", "kit.itemName", "&6&lKits"),
                ...
                KILLCOINS_FURY_MODE_NAME("killcoinsFuryModeName", "killcoins.furyModeName", "&cFury Mode"),
                KILLCOINS_FURY_MODE_LORE("killcoinsFuryModeLore", "killcoins.furyModeLore", "&7You will be immune to snowballs, and you won't consume them.;;&7Duration: &a25s;&7Cost: &a30 Killcoins;;&aClick to activate!"),
