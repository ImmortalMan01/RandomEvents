...
public enum XMaterial {
    ...
    CYAN_TERRACOTTA, LIGHT_BLUE_TERRACOTTA, LIME_TERRACOTTA, MAGENTA_TERRACOTTA,
    ORANGE_TERRACOTTA, PINK_TERRACOTTA, TERRACOTTA,
    ...
    STAINED_GLASS_PANE, WHITE_STAINED_GLASS_PANE, WHITE_TERRACOTTA, WOODEN_HOE, WOODEN_SHOVEL, WOODEN_SWORD,
    YELLOW_TERRACOTTA, BLACK_WOOL, BLUE_WOOL, BROWN_WOOL, GRAY_WOOL,
    GREEN_WOOL, PURPLE_WOOL, RED_WOOL, WHITE_WOOL, YELLOW_WOOL,
