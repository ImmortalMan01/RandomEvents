...
public class ChatKillGoalTest {
    ...
    @Test
    public void validKillGoal() throws Exception {
        invoke("10", Creacion.KILL_GOAL.getPosition());
        Match m = matches.get("p");
        assertEquals(10, m.getKillGoal());
    ...
    @Test
    public void invalidKillGoal() throws Exception {
        invoke("abc", Creacion.KILL_GOAL.getPosition());
        Match m = matches.get("p");
        assertEquals(0, m.getKillGoal());
